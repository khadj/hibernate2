...
import com.example.hibernate2.dao.*;
...
public class Main {
    ...
    private void customerRentInventory(Customer customer) {
        try (Session session = sessionFactory.getCurrentSession()){
            ...
            payment.setAmount(BigDecimal.valueOf(121.52));
    ...
    private Customer createCustomer() {
        try (Session session = sessionFactory.getCurrentSession()){
            ...
            customer.setFirstName("Gaidar");
            customer.setLastName("Kazsport");
